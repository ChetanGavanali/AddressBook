...
public class EditContact {
        ...
        public static ArrayList<com.bridgelabz.EditContact> edit(ArrayList<com.bridgelabz.EditContact> list, String name) {

            Scanner sc=new Scanner(System.in);
            boolean flag=false;
            name.replaceAll("\\P{Print}","");
            String lower_name=name.toLowerCase();
            for (com.bridgelabz.EditContact obj:list) {
        ...
        public static void main(String[] args) {
            ...
            ArrayList<com.bridgelabz.EditContact> record=new ArrayList<com.bridgelabz.EditContact>();

            com.bridgelabz.EditContact entry1=new com.bridgelabz.EditContact("Chetan", "Gavanali",
                    "Mutaga", "Belgaum", "Karnataka", 591124, "9449441490",
                    "chetangavanali@gmail.com");
            record.add(entry1);
            System.out.println(entry1);

            com.bridgelabz.EditContact entry2=new com.bridgelabz.EditContact("ABCD", "EFGH",
